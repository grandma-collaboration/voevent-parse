...
class TestConvenienceRoutines(TestCase):
    ...
    def test_get_event_position(self):
        known_swift_grb_posn = vp.Position2D(
            ra=74.741200, dec=-9.313700, err=0.05, units="deg", system="UTC-FK5-GEO"
        )
    ...
    def test_pull_params(self):
        ...
        with pytest.warns(FutureWarning):
            ...
            self.assertEqual(
                swift_params["Misc_Flags"]["Values_Out_of_Range"]["value"], "false"
            )
